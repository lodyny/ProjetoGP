            ...
            <div class="container footline text-center text-md-left">
                ...
                <div class="row text-center text-md-left pb-3">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto ">
                        ...
                        <p>
                            Alburgue destinado aos nossos amigos peludos ou não.<br />Sem qualquer fins lucrativos.
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto">
                        ...
                        <p><router-link v-if="isAdmin" to="/admin">Administrador</router-link></p>
                        <p><router-link v-if="currentUser" to="/profile">Perfil</router-link></p>
                        <p><router-link v-if="!currentUser" to="/signup">Registar</router-link></p>
                        <p><router-link v-if="!currentUser" to="/login">Entrar</router-link></p>
                    </div>
                    <!-- Grid column -->
